module AuthenticatedSystem
  protected
    ...
    def current_user
			@current_user ||= restore_or_create_user
    end
    ...
    def login_required
      authorized? || access_denied
		...
		#filter method to enforce administrative rights
		def admin?
    ...
    def access_denied
      ...
      respond_to do |format|
        ...
        format.any do
          request_http_basic_authentication 'Login Required'
        end
      end
    end
    ...
    def login_as_guest
      self.current_user = User.new_shell
    end
